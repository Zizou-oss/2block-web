...
export const APK_CONFIG = {
  ...
  downloadUrl:
    'https://github.com/Zizou-oss/2block-web/releases/download/V.1.3.1/2block-music-arm64-v8a.apk',
  // APKs split (optionnel) - pour réduire la taille
  downloadUrlArm64:
    'https://github.com/Zizou-oss/2block-web/releases/download/V.1.3.1/2block-music-arm64-v8a.apk',
  downloadUrlArmv7:
    'https://github.com/Zizou-oss/2block-web/releases/download/V.1.3.1/2block-music-armeabi-v7a.apk',
  downloadUrlX86_64: '',
  downloadUrlX86: '',
  ...
  releasePage: 'https://github.com/Zizou-oss/2block-web/releases/tag/V.1.3.1',
};
